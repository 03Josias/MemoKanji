...
class ExamResultScreen(QWidget):

    def __init__(self, main_window, nivel, modulo, passed, correct, stars):
        super().__init__()
    ...
    def init_ui(self):
        ...
        # Puntaje
        score = QLabel(f"Aciertos: {self.correct} / 10")
        ...
        class_btn = QPushButton("Ir a clase")
        class_btn.clicked.connect(self.go_to_class)

        for btn in [retry_btn, exit_btn, class_btn]:
